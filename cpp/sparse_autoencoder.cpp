...
double compute_cost(const unordered_map<string, MatrixXd> WgtBias, const MatrixXd& data, 
...
unordered_map<string, MatrixXd> compute_batch_grad(unordered_map<string, MatrixXd> WgtBias,
...
unordered_map<string, MatrixXd> compute_stoc_grad(unordered_map<string, MatrixXd> WgtBias, 
                      const MatrixXd& data, int hidden_size_lyr, int visible_size_lyr, 
...
unordered_map<string, MatrixXd> compute_mibt_stoc_grad(unordered_map<string, MatrixXd> WgtBias, 
                const MatrixXd& data, int hidden_size_lyr, int visible_size_lyr, 
...
int main(int argc, const char *argv[])
{
  ...
  auto sgd = compute_stoc_grad(wb, data, 25, 64, 0.0001, 0.01, 3, 6);
